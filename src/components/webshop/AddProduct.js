  ...
  save = async (e) => {
    ...
    if (name && price) {
      ...
      await axios.post(
        ...
        { id, name, price, stock, image, shortDesc, description },
      )
      ...
      <>
        ...
        <form onSubmit={this.save}>
          <div className="columns is-mobile is-centered">
            <div className="add-product-column is-one-third">
              <div className="field">
              ...
              <div className="field is-clearfix">
                <button
                  className="product-button is-primary is-outlined is-pulled-right"
                  type="submit"
                  onClick={this.save}
                >
                  Submit
